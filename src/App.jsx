...
import Schedule from './pages/home/admin/schedule/Schedule';
import Parent from './pages/home/admin/parent/parent';
import AssignStudent from './pages/home/admin/parent/assign';
    ...
    <BrowserRouter>
      <UserProvider>
        ...
        <Routes>
          ...
          <Route path='/admin/parents' element={<Parent />} />
          <Route path='/admin/parents/assign' element={<AssignStudent />} />
